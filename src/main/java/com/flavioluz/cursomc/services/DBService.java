...
import com.flavioluz.cursomc.domain.Cidade;
...
import com.flavioluz.cursomc.domain.PagamentoComCartao;
...
import com.flavioluz.cursomc.domain.enums.TipoCliente;
import com.flavioluz.cursomc.repositories.CategoriaRepository;
import com.flavioluz.cursomc.repositories.CidadeRepository;
import com.flavioluz.cursomc.repositories.ClienteRepository;
import com.flavioluz.cursomc.repositories.EnderecoRepository;
import com.flavioluz.cursomc.repositories.EstadoRepository;
...
import com.flavioluz.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "frpluz@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220831", cli1, c1);
